    ...
    <section className="px-6 max-w-4xl mx-auto mt-20">
      ...
      >
        ...
        >
          ...
          <path
            d="M130 180 L140 170 L155 165 L170 160 L185 155 L195 160 L210 155 L220 150 L230 155 L240 150 L250 145 L260 150 L265 155 L270 150 L275 145 L280 150 L275 160 L270 165 L275 170 L285 175 L290 170 L295 165 L300 160 L310 155 L315 160 L320 165 L325 170 L330 165 L335 160 L340 155 L345 160 L340 170 L335 175 L330 180 L325 185 L320 190 L315 195 L310 200 L305 205 L300 195 L295 190 L290 185 L285 180 L280 175 L275 180 L265 185 L260 180 L255 175 L250 180 L245 185 L240 180 L235 175 L230 170 L225 175 L220 180 L215 185 L210 180 L200 175 L195 180 L190 185 L185 180 L180 175 L175 180 L170 185 L165 190 L160 195 L155 200 L150 195 L145 190 L140 185 L135 180 L130 180Z"
          ...
          {cities.map((city) => (
            <g key={city.name}>
              ...
              <circle
                ...
                fill="none"
                stroke={hovered === city.name ? "#64d2ff" : "rgba(100,210,255,0.3)"}
              ...
              <circle
                ...
                style={{ animationDelay: `${(city.name.charCodeAt(0) % 20) * 0.1}s` }}
              />
              {/* Hover area */}
              <circle
                cx={city.x}
          ...
          <g transform="translate(680, 420)">
            <circle cx="0" cy="0" r="2" fill="#64d2ff" className="animate-pulse-dot" />
            <text x="10" y="3" fill="rgba(255,255,255,0.3)" fontSize="10">
              已点亮
            </text>
          </g>
        </svg>
